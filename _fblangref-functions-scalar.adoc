...
Функция возращает результат типа `BIGINT`, если в качестве первого аргумента явно не передано число типа `INT128`. Таким образом, следующие вырадения дадут разные результаты.
