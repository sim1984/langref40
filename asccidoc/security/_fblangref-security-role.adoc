...
<<fblangref-security-priv-grant,GRANT>>,
<<fblangref-security-priv-revoke,REVOKE>>,
<<fblangref-management-role-setrole,SET ROLE>>,
<<fblangref-scalarfuncs-system-privelege,RDB$SYSTEM_PRIVILEGE>>.
...
.См. также:
<<fblangref-security-roles-create,CREATE ROLE>>, <<fblangref-security-priv-revoke,REVOKE>>.
