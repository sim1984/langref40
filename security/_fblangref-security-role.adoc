...
Для проверки имеет ли текущее подключение заданную системную привилегию можно воспользоваться встроенной функцией <<fblangref-scalarfuncs-system-privilege,`RDB$SYSTEM_PRIVILEGE()`>>.
...
<<fblangref-scalarfuncs-system-privilege,RDB$SYSTEM_PRIVILEGE>>.
